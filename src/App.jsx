...
function App() {
  ...
  const getData = async () => {
    try {
      ...
      const filterPhonetic = await response.data[0].phonetics.filter(phonetic => {
      ...
      const filterMeaningsNoun = await response.data[0].meanings.filter(meanings => {
      ...
      const filterMeaningsVerb = await response.data[0].meanings.filter(meanings => {
    ...
    <div className="App" style={{backgroundColor: ballMargin == '0px'? '#FFF': '#050505'}}>
      ...
      <div className="result">
        ...
        <div className="synonyms-div">
          ...
          <p className="synonym" style={{fontFamily: fontFamily}}>{synonym}</p>
        </div>}
