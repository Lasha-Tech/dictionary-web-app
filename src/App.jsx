  ...
  return (
    <div className="App" style={{backgroundColor: ballMargin == '0px'? '#FFF': '#050505'}}>
      ...
      <svg className='book-svg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 34" fill="none">
        ...
        <path d="M4.50685 32.5616C3.57675 32.5616 2.6848 32.1921 2.02713 31.5344C1.36947 30.8768 1 29.9848 1 29.0547C1 28.1246 1.36947 27.2326 2.02713 26.575C2.6848 25.9173 3.57675 25.5479 4.50685 25.5479" stroke="#757575" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M9.76709 8.0138H20.2876" stroke="#757575" stroke-width="1.5" stroke-linecap="round"/>
      </svg>
          ...
          <div className='day-night-div'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M1 10.449C0.998458 12.8283 1.80169 15.1383 3.27914 17.0033C4.75659 18.8683 6.82139 20.1788 9.13799 20.7218C11.4545 21.2647 13.8866 21.0082 16.039 19.994C18.1912 18.9797 19.9373 17.2673 20.9931 15.1352C11.5442 15.1352 6.85799 10.4479 6.85799 1C5.09842 1.87311 3.61767 3.22033 2.58266 4.88981C1.54765 6.5593 0.999502 8.48469 1 10.449Z"
               style={{stroke: ballMargin == '0px'? '#757575': '#A445ED'}} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        </div>
      </div>
      ...
      <div className="result">
        <div className="word-result">
          ...
          <div className="word-pronounce">
            <p style={{fontFamily: fontFamily, color: ballMargin == '0px'? '#2D2D2D': '#FFF'}} className="word">{}</p>
            <p className="word-saying-form">{}</p>
          </div>

          {/* Word Audio  */}
          <svg className='audio-player' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none">
